...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t0 = text(/*suggestedCommander*/ ctx[0]);
    			t1 = text(" with prestige ");
    			t2 = text(/*suggestedPrestige*/ ctx[1]);
    			add_location(p, file, 43, 2, 2623);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*suggestedCommander*/ 1) set_data_dev(t0, /*suggestedCommander*/ ctx[0]);
    			if (dirty & /*suggestedPrestige*/ 2) set_data_dev(t2, /*suggestedPrestige*/ ctx[1]);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(43:1) {#if suggestedCommander !== ''}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*suggestedCommander*/ ctx[0] !== "" && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Starcraft 2 Coop Random";
    			t1 = space();
    			p = element("p");
    			p.textContent = "Click the button to get a random commander and a random prestige.";
    			t3 = space();
    			button = element("button");
    			button.textContent = "Random!";
    			t5 = space();
    			if (if_block) if_block.c();
    			add_location(h1, file, 39, 1, 2427);
    			add_location(p, file, 40, 1, 2461);
    			add_location(button, file, 41, 1, 2535);
    			add_location(main, file, 38, 0, 2419);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*updateSuggestion*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (/*suggestedCommander*/ ctx[0] !== "") {
    				if (if_block) {
    ...
    function getRandomPrestige(commander) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const commanders = [
    		...
    		{
    			name: "Stukov",
    			prestiges: ["Frightful Fleshwelder", "Plague Warder", "Lord of the Horde"]
    		},
    		{
    			name: "Fenix",
    	...
    	function updateSuggestion() {
    		...
    		$$invalidate(0, suggestedCommander = randomCommander.name);
    		const randomPrestige = getRandomPrestige(randomCommander);
    		$$invalidate(1, suggestedPrestige = randomPrestige);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("suggestedCommander" in $$props) $$invalidate(0, suggestedCommander = $$props.suggestedCommander);
    		if ("suggestedPrestige" in $$props) $$invalidate(1, suggestedPrestige = $$props.suggestedPrestige);
    	};
    	...
    	return [suggestedCommander, suggestedPrestige, updateSuggestion];
    }
